...
-- player_sheet = image.new('player_sheet')
-- player_idle_frames = animation_frames.new(player_sheet, 32, 32, {{1, 1}, {2, 1}})
-- player_run_frames = animation_frames.new(player_sheet, 32, 32, {{1, 2}, {2, 2}, {3, 2}})
-- player_attack_frames = animation_frames.new(player_sheet, 32, 32, {{1, 3}, {2, 3}, {3, 3}, {4, 3}})
--
