...
function layer(x, y, args) return anchor('layer', args):layer_init(x, y) end
...
function main:draw_layers()
  for _, layer in ipairs(main.layer_objects) do 
    main:draw_to_canvas(main.canvas, function() 
      layer:layer_draw_to()
      layer:layer_draw()
    end)
  end
...
-- draw_canvas and draw_to_canvas here draw to the screen directly and are used only on layer_draw, when drawing the layer to the screen
-- or at the bottom of this file when drawing the main canvas to the screen; layer's draw_canvas and draw_to_canvas are indirect and to be used by gameplay code
local white = {r = 1, g = 1, b = 1, a = 1}
function main:draw_canvas(canvas, x, y, r, sx, sy, color, shader, flat)
...
function main:draw_to_canvas(canvas, action)
...
function love.run()
  ...
  return function()
    ...
    if love.graphics and love.graphics.isActive() then
      ...
      love.graphics.clear()
      main:draw_layers()
      main:draw_canvas(main.canvas, main.rx*0.5, main.ry*0.5, 0, main.sx, main.sy)
