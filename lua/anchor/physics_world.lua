...
-- world:set_collision_tags{'player', 'enemy', 'projectile', 'ghost'}
...
-- world:enable_collision_between('player', {'enemy', 'enemy_projectile'}) -> 'player' now physically collides with 'enemy' and 'enemy_projectile'
...
-- world:disable_collision_between('ghost', {'player', 'solid'}) -> 'ghost' now doesn't physically collide with 'player' and 'solid'
...
-- world:disable_collision_between('ghost', 'player')
-- world:enable_trigger_between('ghost', {'player'}) -> now when a ghost passes through a player, the ghost's enter/exit collision callback functions will be called.
