...
-- animation = animation_logic.new({0.02, 0.04, 0.06, 0.04}, ...)
...
-- self.animation = animation_logic.new(0.04, self.player_dead_frames.size, 'once', {[0] = function() self.dead = true end})
